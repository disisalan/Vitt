...
function navigateToIndexPage() {
    setTimeout(() => { window.location.href = 'v1.02.html'; }, 6500);
...
const checkBlackFillPercentage = () => {
  ...
  if (blackFillPercentage >= 1) {
    ...
    var downloadTimer = setInterval(function(){
        ...
        scratchCardText.innerHTML = '🎉 Unlocking your reward <br> in ' + timeleft + ' seconds';
        timeleft -= 1;
        }, 1000);
    ...
    // scratchCardText.innerHTML = '🎉 Unlocking your reward <br>in 10 seconds';
